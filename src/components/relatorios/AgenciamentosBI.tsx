...
import { Building2, MapPin, TrendingUp, Users, CheckCircle, RefreshCw, XCircle, Home } from "lucide-react";
...
export function AgenciamentosBI() {
  ...
  // Evolução semanal (status do dia atual)
  ...
  if (list.length === 0) {
    return (
      <div className="elevated-card rounded-xl p-8 text-center">
        ...
        <p className="text-sm text-muted-foreground">Importe sua planilha pelo botão "Dados Manuais" no topo da página.</p>
      </div>
    );
  }
