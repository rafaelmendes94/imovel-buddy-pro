...
export const PUBLIC_IMOVEL_COLUMNS = [
  ...
  "posicao_predio", "posicao_solar", "vista",
  "termo_exclusividade", "infraestrutura", "outras_caracteristicas",
  "preco_parcelado", "elevadores",
  ...
  "termo_exclusividade_url", "drive_fotos_url", "fotos_pdf_url",
].join(", ");
