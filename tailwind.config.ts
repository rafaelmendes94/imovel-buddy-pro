    ...
    extend: {
      ...
      keyframes: {
        ...
        "sold-pulse": {
          ...
          "50%": { transform: "scale(1.02)", boxShadow: "0 0 0 12px hsl(var(--accent) / 0)" },
      ...
      animation: {
        ...
        "sold-pulse": "sold-pulse 0.8s ease-out",
        "sold-stamp": "sold-stamp 0.5s cubic-bezier(0.25, 0.46, 0.45, 0.94) forwards",
      },
    },
  },
